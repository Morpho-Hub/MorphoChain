  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <Button
        ...
        variant="white"
        className="w-full !bg-white !text-gray-900 hover:!bg-gray-100 !border-2 !border-gray-200 !rounded-xl !py-3 !px-6 !font-semibold !transition-all !duration-300 !shadow-lg hover:!shadow-xl flex items-center justify-center gap-2"
      >
